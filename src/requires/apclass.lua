function APClass(Nav, c, u, atlas, vBooster, hover, telemeter_1, antigrav, dbHud_1,
    ...
    function ap.onFlush()
        ...
        local function planetTarget()
            ...
            if CustomTarget and CustomTarget.planetname == "Space" then return CustomTarget.position + (worldPos - CustomTarget.position):normalize()*AutopilotSpaceDistance end
