...
-- Modified Jaylebreak's library importation
require("autoconf/custom/archhud/planetref")
require("autoconf/custom/archhud/kepler")
require("autoconf/custom/archhud/kinematics")
    ...
    function script.onStart()
        -- Local functions for onStart
            ...
            local function atlasSetup()
                ...
                Kinematic = Kinematics(mabs, msqrt)
                Kep = Keplers(msqrt)

                ATLAS = AtlasClass(atlas, sysUpData, sysAddData, mfloor)
            end
