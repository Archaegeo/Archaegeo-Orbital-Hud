...
-- Ship Handling variables
    ...
    SpaceSpeedLimit = 60000 --export: (Default: 60000) Space speed limit in KM/H. If you hit this speed and are NOT in active autopilot, engines will turn off to prevent using all fuel (60000 means they wont turn off)
    ...
    MaxGameVelocity = 13888.87 --export: (Default: 13888.87) Max speed for your autopilot in m/s, do not go above 16666.66 (60000 km/hr), can be reduced to save fuel. Some ships will not turn off engines if 13888.88 is used.
...
local requireTable = {"autoconf/custom/archhud/hudclass", "autoconf/custom/archhud/apclass", "autoconf/custom/archhud/controlclass",
