...
-- User variables. Must be global to work with databank system
    ...
    -- NOTE: savableVariablesHandling below must contain any Ship Handling variables that needs to be saved/loaded from databank system
        ...
        MaxGameVelocity = 13888.00 --export: (Default: 13888.00) Max speed for your autopilot in m/s, do not go above 13888.87 (50000 km/hr), can be reduced to save fuel. Some ships will not turn off engines if 13888.87 is used.
