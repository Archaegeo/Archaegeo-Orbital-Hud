...
* While out of seat, edit the settings in unit->start, you will need to scroll down to see them.  You will need to set useTheseSettings to true if you need to override values saved on databank.
